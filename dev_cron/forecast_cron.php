...
include('../dev/includes/simple_html_dom.php');
	   ...
	   // mysql_query($deldata);
		...
		foreach($html->find('div.day') as $oneday)
		{
			...
			if($myday==0)
			{
			    ...
			    if (file_exists('/home/situatio/public_html/dev/images/forecast/transparent/'.$image_name_new)) 
				{
				}
				else
				{
					define('DIRECTORY', '/home/situatio/public_html/dev/images/forecast/transparent');
			...
			if (file_exists('/home/situatio/public_html/dev/images/forecast/transparent/'.$only_image_name)) 
			{
