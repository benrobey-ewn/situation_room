<?php  header("Access-Control-Allow-Origin: *");
    ...
    */
    ...
    if($radarType=='512') {
        ...
        WHERE
            RC.radar_type=".$radarType." AND RC.radar_key NOT IN (56,23,19,73,24,72,50,66,53,69,4,3,40,9,63,64,68,37,2,49,30,31,32,6,29,39,36) AND ((RC.min_long >=".$viewportLonMax." AND max_long <= ".$viewportLonMin." AND min_lat >=".$viewportLatMax." AND max_lat <=".$viewportLatMin.") OR (
