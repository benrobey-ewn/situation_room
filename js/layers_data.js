...
$(document).ready(function () {
	...
	$('#select_client_data').change(function () {
		...
		onCheckAll: function () {
			...
			if(settings.datalayer.publicLayer!== 'undefined' && settings.datalayer.publicLayer!== undefined){
		...
		onClick: function (view) {
			...
			if (view.checked == true) {
				...
				client_loaded_count = 0;
				if (view.value !== '12' && view.value !== '19' && view.value !== '38' && view.value !== '39' && view.value !== '45' && view.value !== '46' && view.value !== '47' && view.value !== '52' && view.value !== '53' && view.value !== '94' && view.value !== '95' && view.value !== '96' && view.value !== '101' && view.value !== '102' && view.value !== '104' ) {
					$('#site_list_option').show();
