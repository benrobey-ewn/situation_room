	...
	//var cyclone_intervalTime=60000;
	
	function show_cyclone() {
		$("#checkbox-cyclone").css('display', 'none').attr("disabled",true);
		...
		var url='https://static.ewn.com.au/cyclone/cyclone.kml?ref='+d;
		gp.parse(url);
	...
	function kmlParseComplete() {
		 ...
		 $("#checkbox-cyclone").css('display', 'inline-block').attr("disabled",false);
	}
