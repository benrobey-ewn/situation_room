			...
			<div class="row lightning hide">
				...
				<div class="col-md-12 content-collapse">
					...
					<div class="row">
						<div class="col-md-12">
							<div class="info-text info-text-sml">
								<p>* Please note selecting one of these options will take a while to produce results due to large volume of data. Suggest turning off all over layers before selecting one of these options.</p>
							</div>
						</div>
					</div>
