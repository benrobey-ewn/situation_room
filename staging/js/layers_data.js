	...
	$('#select_client_data').change(function () {
			...
			$('#showClientDataDropDownDiv input:checked').each(function () {
				...
				if (e !== 'on') {
					if ((jQuery.inArray(e, current_selected_layer)) == -1) {
						if (e !== '12' && e !== '19' && e !== '38' && e !== '39' && e !== '45' && e !== '46' && e !== '47' && e !== '52' && e !== '53' && e !== '94' ) {
						...
						current_selected_layer.push(layer_value);
						client_checked_options.push(layer_value);
					}
				}
			});
		...
		onClick: function (view) {
			...
			if (view.checked == true) {
				...
				client_loaded_count = 0;
				if (view.value !== '12' && view.value !== '19' && view.value !== '38' && view.value !== '39' && view.value !== '45' && view.value !== '46' && view.value !== '47' && view.value !== '52' && view.value !== '53' && view.value !== '94' ) {
					$('#site_list_option').show();
