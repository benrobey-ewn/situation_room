...
/* curl for send push alert to ewn situation room dev push http://situationroom.ewn.com.au */
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL,"http://situationroom.ewn.com.au/dev_push/push_alerts.php");
curl_setopt($ch, CURLOPT_POST, 1);
curl_setopt($ch, CURLOPT_POSTFIELDS,$my_raw_data);
// receive server response ...
curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
curl_setopt($ch, CURLOPT_HTTPHEADER, array('Content-Length: ' . strlen($my_raw_data)));     
