...
$LOGIN_USER_NAME = trim(mysql_real_escape_string($_POST['LOGIN_USER_NAME']));

if($LOGIN_USER_NAME=='admin' || $LOGIN_USER_NAME=='bechtel')
{
...
if($numst!=0)
{
	while($fetchst = mysql_fetch_object($rsst))
	{
		...
		if (file_exists('/home/situatio/public_html/dev/images/forecast/transparent/'.$fetchst->icon_name)) 
		{
