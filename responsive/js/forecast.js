        ...
        success: function(response)
        {
            ...
            if(response.marker_data.length>0)
            {
                for (i=0;i<response.marker_data.length;i++)
                {
                    ...
                    // info window
                   // for (i=0;i<response.marker_info.length;i++)
                    google.maps.event.addListener(forecast_marker, 'click', (function(marker, i)
                    {
                        return function()
                        {
                            var finalHTML = '<div align="left" style="width:640px; " class="iphone_scroll">';
                            ...
                            finalHTML = finalHTML+'</tr></thead>';
                               ...
                               // console.log(response.marker_info[state_title].length);
                                //console.log(response.marker_info[response.marker_data[i].state_name][j].forecast_title);
