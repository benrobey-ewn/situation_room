    ...
    var places={
	    ...
	    ['Alice',-23.80  , 133.89],
	    ['Cairns',-16.87  , 145.75 ],
        ['Learmonth',-22.214426, 114.094935 ]
	    ]
	    }
	    };
	...
	google.maps.event.addListener(map, 'tilesloaded', function() {
	 ...
	 google.maps.event.addListener( map, 'maptypeid_changed', function() {
          ...
          map_type_value = map.getMapTypeId().toUpperCase();
          if(map_type_value=="HYBRID"){
            map_type_value="SATELLITE";
          }
          $('#map_options_selector').find("option").removeAttr('selected');
          $('#map_options_selector').find("option[value='"+map_type_value+"']").attr("selected",true);
          setting[5].map_option = map_type_value;
          update_setting();
    });
		...
		/* generate timers array */
		    ...
		    $.each(data, function () {
			  ...
			  // var img="http://static.ewn.com.au/"+"/images/radar/" + this.fn;
				//var img='http://aeeris.com/radar_dev/radar_images/'+ this.fn;
				var img='http://aeeris.com/radar_images/'+ this.fn;
	...
	//var url = "http://www.ewn.com.au/exo/webextensions.asmx/" + callMethod;
	    //var url="http://aeeris.com/radar_dev/radar/getRadar.php";
	    var url="http://aeeris.com/radar/getRadar.php";
	    if(is_loader)
            $('#loader').show();
	...
	// After 30 sec assume all frame images downloaded	
		setTimeout( function() {
				downloadedlastdownloadedImages=totalRadar;
				downloadedsixframeImages=totalsixframeImages;
				downloadedfifthframeImages=totalfifthframeImages;
				downloadedfourthframeImages=totalfourthframeImages;
				downloadedthirdframeImages=totalthirdframeImages;
				downloadedsecondframeImages=totalsecondframeImages;
				downloadedfirstframeImages=totalfirstframeImages;
			},30000);
