    ...
    var filtermarkers = [];
     ...
     var forecastmapMarkersArray = []; // global array for forcast images
       ...
       // Railway Track
       RT_NSW = new google.maps.KmlLayer('<?php echo RT_NSW; ?>',{
                      map: map,
                      preserveViewport: true
                  });
     RT_NT = new google.maps.KmlLayer('<?php echo RT_NT; ?>',{
                      map: map,
                      preserveViewport: true
                  });
     RT_QLD = new google.maps.KmlLayer('<?php echo RT_QLD; ?>',{
                      map: map,
                      preserveViewport: true
                  });
     RT_SA = new google.maps.KmlLayer('<?php echo RT_SA; ?>',{
                      map: map,
                      preserveViewport: true
                  });
     RT_TAS = new google.maps.KmlLayer('<?php echo RT_TAS; ?>',{
                      map: map,
                      preserveViewport: true
                  });
     RT_VIS = new google.maps.KmlLayer('<?php echo RT_VIS; ?>',{
                      
                      map: map,
                      preserveViewport: true
                  });
     RT_WA = new google.maps.KmlLayer('<?php echo RT_WA; ?>',{
                      map: map,
                      preserveViewport: true
                  });
