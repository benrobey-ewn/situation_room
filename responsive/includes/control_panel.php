...
?>
      ...
      <div class="logout_btn"><a href="logout.php"><img class="mobile_view_btn" src="images/logout-icon.png"><img class="desktop_view_btn" src="images/logout.png"></a></div>
      <div class="Room">
          <ul>
          <li> 
              <!--First Box-->
        ...
        <li> 
         ...
         <!-- rainfall gage -->
          ...
          <!-- aaaaaaaaaaaaaaaa -->
         <!--  <?php //if($_SERVER['PHP_AUTH_USER']=='suncorp' || $_SERVER['PHP_AUTH_USER']=='admin') { ?> -->
        ...
        <li> 
             ...
             <ul>
              ...
              <?php if($_SERVER['PHP_AUTH_USER']=='admin' || $_SERVER['PHP_AUTH_USER']=='forecasters') {?>
              <li style="margin-bottom: 10px;">
                 <span class="width50">
                 <h3 style="float:left;" class="nomargin">
