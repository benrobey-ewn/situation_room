<?php
include '../situation_room/includes/config.php'; 
include('../situation_room/includes/simple_html_dom.php');
	   ...
	   // mysql_query($deldata);
		...
		foreach($html->find('div.day') as $oneday)
		{
			...
			if($myday==0)
			{
			    ...
			    if (file_exists('/home/aeerisco/public_html/situation_room/images/forecast/transparent/'.$image_name_new)) 
				{
				}
				else
				{
					define('DIRECTORY', '/home/aeerisco/public_html/situation_room_dev/images/forecast/transparent');
			...
			if (file_exists('/home/aeerisco/public_html/situation_room/images/forecast/transparent/'.$only_image_name)) 
			{
