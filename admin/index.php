...
<head>
  ...
  <link rel="stylesheet" href="dt/dataTables.bootstrap.min.css?v=<?php echo FILE_VERSION; ?>">
  <link href="../js/datepicker/css/bootstrap-datetimepicker.min.css?v=<?php echo FILE_VERSION; ?>" rel="stylesheet">
</head>
<body>
...
<script src="dt/jquery.dataTables.min.js?v=<?php echo FILE_VERSION; ?>"></script>
<script src="dt/dataTables.bootstrap.min.js?v=<?php echo FILE_VERSION; ?>"></script>

<script type="text/javascript" src="../js/moment.min.js?v=<?php echo FILE_VERSION; ?>"></script>
<script type="text/javascript" src="../js/datepicker/js/bootstrap-datetimepicker.min.js?v=<?php echo FILE_VERSION; ?>"></script>
</html>
<!-- modal for  updation -->
<!-- Modal -->
   ...
   <form method="POST" action="core.php" id="update_alert_form" class="update_alert_form" >
    <div class="modal-content">
      ...
      <div class="form-group">
       ...
       <input type="text" name="subject" id="subject" class="form-control" id="alert_subject" placeholder="Subject">
     </div>
     <div class="form-group"> 
      <label for="datepicker">Expire Date</label>
      <div class='input-group date' id=''>
        <input type='text' id="datepicker" name="expire_datetime" class="form-control" />
...
<script>
  ...
  $(document).ready(function() {
    ...
    $(document).on("click",".expire_now",function(event){
      var $this = $(this);
      var $id =  $this.data('id');
      if(confirm("Are you sure, you want to expire this alert?")){
        $.ajax({
          url: 'core.php?expire_now=1&alert_id='+$id,
          type: 'GET',
          dataType: 'JSON',
