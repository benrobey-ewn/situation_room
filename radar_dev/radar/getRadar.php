<?php  header("Access-Control-Allow-Origin: *");
    ...
    */
    ...
    if($radarType=='512') {
        ...
        WHERE
            RC.radar_type=".$radarType." AND RC.radar_key NOT IN (56,23,19,73,72,50,66,53,69,3,40,9,63,64,68,37,2,30,31,32,6,29,39,55,22,65) AND ((RC.min_long >=".$viewportLonMax." AND max_long <= ".$viewportLonMin." AND min_lat >=".$viewportLatMax." AND max_lat <=".$viewportLatMin.") OR (
    ...
    while($data=  mysql_fetch_array($result)) {
        ...
        $radar_obj->url = '../dev/radar_images/'.$data['image_name'];
        //////
