            ...
            success: function(response)
            {
                ...
                for (k=0;k<response.data.length;k++) {
                    ...
                    if(response.data[k].corodinates.length!==0) {
                      ...
                      draw_map(coordinates_json,response.data[k].color,response.data[k].AlertFullURL,parseInt(response.data[k].id),'warning');
                    }
               ...
               controlText.innerHTML = controlText.innerHTML + '<div style="clear: both;width: 204px;border: 1px solid #999;margin: 0 auto; height:254px;background-color:#FFF">'
                ...
                +'<li style="float:left; width:100%;">'
                  ...
                  +'<div style="margin-bottom: 1px;clear: both;padding: 2px 10px;">'
                    ...
                    +'</div>'
                    +'<h3 style="margin:0;padding:0;width: 100%;font-size: 13px;font-weight: normal;color: #000;text-align:left;">Bushfire Warning</h3>'
                  +'</div>'
                  +'<div style="margin-bottom: 1px;clear: both;padding: 2px 10px;">'
                    +'<div style="width: 40px;margin: 0;padding: 0;text-align: center;float: left;">'
                     +'<img src="images/box/purple.png" width="18" height="18">'
                    +'</div>'
                    +'<h3 style="margin:0;padding:0;width: 100%;font-size: 13px;font-weight: normal;color: #000;text-align:left;">Bushfire Watch and ACT</h3>'
                  +'</div>'
                  +'<div style="margin-bottom: 1px;clear: both;padding: 2px 10px;">'
                    +'<div style="width: 40px;margin: 0;padding: 0;text-align: center;float: left;">'
