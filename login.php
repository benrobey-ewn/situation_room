...
<head>
  ...
  <link rel="stylesheet" href="css/login.css?v=<?php echo SR_VER; ?>">
   <link rel="stylesheet" href="css/jquery-ui.css?v=<?php echo SR_VER; ?>">
...
<body>
  ...
  <script  src="js/jquery-1.10.2.min.js?v=<?php echo SR_VER; ?>"></script>
  <script src="js/jquery-ui.js?v=<?php echo SR_VER; ?>"></script>
  <script src='js/jquery.validate.min.js?v=<?php echo SR_VER; ?>'></script>
