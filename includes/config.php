...
/*
 *
 * THE FOLLOWING BLOCK IS FROM WHAT WAS IN THE NBN/LIGHTNING/RADAR LOOP DEV ENVIRONMENT
 *
 */

define('RT_NT', KML_DATA_PATH.'/RT/NT.kmz');//RTLayer2
define('RT_QLD', KML_DATA_PATH.'/RT/QLD.kmz');
define('RT_SA', KML_DATA_PATH.'/RT/SA.kmz');
define('RT_TAS', KML_DATA_PATH.'/RT/TAS.kmz');
define('RT_VIS', KML_DATA_PATH.'/RT/VIC.kmz');
define('RT_WA', KML_DATA_PATH.'/RT/WA.kmz');
...
define('KML_DATA_PATH', 'https://situationroom.ewn.com.au/kml_data/kml');

//define('DEV_KML_DATA_PATH', ROOT_PATH.'dev/kml_data/kml');

// Railway Track

/*define('RT_NSW', DEV_KML_DATA_PATH.'/RT/NSW.kmz');//RTLayer1

define('RT_NT', DEV_KML_DATA_PATH.'/RT/NT.kmz');//RTLayer2

define('RT_QLD', DEV_KML_DATA_PATH.'/RT/QLD.kmz');//RTLayer3

define('RT_SA', DEV_KML_DATA_PATH.'/RT/SA.kmz');//RTLayer4

define('RT_TAS', DEV_KML_DATA_PATH.'/RT/TAS.kmz');//RTLayer5

define('RT_VIS', DEV_KML_DATA_PATH.'/RT/VIC.kmz');//RTLayer6

define('RT_WA', DEV_KML_DATA_PATH.'/RT/WA.kmz');//RTLayer7*/

define('RT_NSW1', KML_DATA_PATH.'/RT/NSW-1.kmz');//RTLayer7
define('RT_NSW2', KML_DATA_PATH.'/RT/NSW-2.kmz');//RTLayer7
define('RT_NSW3', KML_DATA_PATH.'/RT/NSW-3.kmz');//RTLayer7
define('RT_QLD1', KML_DATA_PATH.'/RT/QLD-1.kmz');//RTLayer7
define('RT_QLD2', KML_DATA_PATH.'/RT/QLD-2.kmz');//RTLayer7
define('RT_QLD3', KML_DATA_PATH.'/RT/QLD-3.kmz');//RTLayer7
define('RT_QLD4', KML_DATA_PATH.'/RT/QLD-4.kmz');//RTLayer7
define('RT_QLD5', KML_DATA_PATH.'/RT/QLD-5.kmz');//RTLayer7
define('RT_QLD6', KML_DATA_PATH.'/RT/QLD-6.kmz');//RTLayer7
define('RT_QLD7', KML_DATA_PATH.'/RT/QLD-7.kmz');//RTLayer7
define('RT_QLD8', KML_DATA_PATH.'/RT/QLD-8.kmz');//RTLayer7
define('RT_WA1', KML_DATA_PATH.'/RT/WA-1.kmz');//RTLayer7
define('RT_WA2', KML_DATA_PATH.'/RT/WA-2.kmz');//RTLayer7
define('RT_VIC1', KML_DATA_PATH.'/RT/VIC-1.kmz');//RTLayer7
define('RT_VIC2', KML_DATA_PATH.'/RT/VIC-2.kmz');//RTLayer7
define('RT_VIC3', KML_DATA_PATH.'/RT/VIC-3.kmz');//RTLayer7
define('RT_VIC4', KML_DATA_PATH.'/RT/VIC-4.kmz');//RTLayer7
define('RT_VIC5', KML_DATA_PATH.'/RT/VIC-5.kmz');//RTLayer7
...
define('FTTN_SITES', KML_DATA_PATH.'/FTTN_Sites.kml');//KMLLayer 110
...
{
    $clients = mysql_query("SELECT * FROM `clients` WHERE `id`= '".$_SESSION['user_id']."'");
