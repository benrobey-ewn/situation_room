...
UTILITY_LINES = '<?php echo UTILITY_LINES;?>';

CORE_NETWORK_SITES  = new google.maps.KmlLayer('<?php echo CORE_NETWORK_SITES; ?>',{
map: map,
preserveViewport: true
});

NFAS_SITES          = new google.maps.KmlLayer('<?php echo NFAS_SITES; ?>',{
map: map,
preserveViewport: true
});

NWAS_SITES          = new google.maps.KmlLayer('<?php echo NWAS_SITES; ?>',{
map: map,
preserveViewport: true
});

FTTN_SITES 			= new google.maps.KmlLayer('<?php echo FTTN_SITES; ?>',{
map: map,
preserveViewport: true
});

EDL_SITES = new google.maps.KmlLayer('<?php echo EDL_SITES; ?>',{
map: map,
preserveViewport: true
});

NRC_PIPELINES = new google.maps.KmlLayer('<?php echo NRC_PIPELINES; ?>',{
map: map,
preserveViewport: true
});
