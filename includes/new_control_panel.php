...
<div class="col-md-3" id="nav-container">
	<div class="row Popcontainer" id="Popcontainer">
		<div class="col-md-12 padding-helper">
			...
			<div class="row radar">
				...
				<div class="col-md-12 content-collapse" id="radars_box">
					...
					<div class="row radar-weather-sites container-btm-mrgn">
						...
						<div class="col-md-6">
							<button type="button" value="Radar" class="btn btn-sm " onclick="javascript:newPopup('<?php echo $externalRadarLink ?>','512','600');" ><i class="icon-external-link"></i> Pop Out</button>
						</div>
					</div>
			...
			<?php if($_SESSION['username']=='admin' || $_SESSION['username']=='santos'){ ?>
				...
				<div class="col-md-12 content-collapse">
					<div class="row">
						<div class="col-md-12">
							<div class="info-text info-text-sml">
								<p>
									The lightning overlay shows the past hour's lightning strikes, with red markers most recent to blue the oldest.
									A dot marker indicates a cloud to cloud (CC) lightning stroke.
									A cross marker indicates a positive cloud to ground (CG) lightning stroke.
									A triangle marker indicates a negative cloud to ground (CG) lightning stroke.
									Move your mouse over the strike to see information about the strike.
					...
					<div class="row">
						<div class="col-md-6">
							<input type="checkbox" id="checkbox-1-8" class="regular-checkbox observation_option1">
								<label for="checkbox-1-8">Cities only</label>
							</div>
						<div class="col-md-6">
							<input type="checkbox" id="checkbox-1-9" class="regular-checkbox observation_option2">
								<label for="checkbox-1-9">All</label>
							</div>
					</div>
				</div>
			</div><!-- /observations-->
			...
			<div class="row warnings">
				...
				<div class="content-collapse col-md-12" id="warnings_box">
					...
					<div class="row warnings-current">
						...
						<div class="col-md-6">
							<button type="button" value="Alerts" class="btn btn-sm " onclick="javascript:newPopup('common/alert.php','800','660');">
			...
			<div class="row satellite">
				...
				<div class="content-collapse col-md-12">
					...
					<div class="row" style="margin-bottom: 10px;">
						...
						<div class="col-md-3">
							<button type="button" value="Satellite" class="btn btn-sm " onclick="javascript:newPopup('common/bom.satellite.php','641','600');"><i class="icon-external-link"></i> Pop Out</button>
						</div>
					</div>
