...
<div class="col-md-3" id="nav-container">
	<div class="row Popcontainer" id="Popcontainer">
		<div class="col-md-12 padding-helper">
				...
				<div class="col-md-12 content-collapse">
					<div class="row">
						<div class="col-md-12">
							<div class="info-text info-text-sml">
								<p>
									This overlay shows lightning strikes, with white markers most recent to red the oldest.<br>
					...
					<div class="row">
						...
						<div class="col-md-12">
                            ...
                            <div class="col-md-4">
                            	<div style="text-align: center;"><img src="images/lightningbar.png"></div>
                            </div>
						</div>
					</div>
                    <!--<div class="row">
					...
					<div class="row warnings-flood-fire">
						<div class="col-md-6">
							<span class="width50">
								...
								<label for="checkbox-1-106" class="label-inline">Flood Watches & Warnings</label>
							</span>
						</div>
						<div class="col-md-6">
							<span class="width50">
			...
			<div class="row map-options">
				...
				<div class="content-collapse col-md-12" id="map_option_box">
					<div class="row">
						<div class="col-md-12">
							<div class="info-text info-text-sml">
								<p>Allows you to change the Google Map background or overlay spatial data for river catchments, BoM forecast districts or BoM fire weather districts.</p>
							</div>
						</div>
					</div>
					...
					<div class="row mapoptions_regions_catchments">
						<div class="col-md-6">
							...
							<label for="weatherregions">Forecast Districts</label>
						</div>
						<div class="col-md-6">
						...
						<div class="col-md-6">
							<input type="checkbox" id="firedistrict" class="regular-checkbox">
							<label for="firedistrict">Fire Weather Districts</label>
						</div>
					</div>
				</div>
			</div>
			...
			<?php if(!isset($_SESSION['is_authorised_nbn_user'])){?>
			<div class="row draw-polygon-model">
				<div class="header-collapse col-md-12 border-bottom-20">
					<div class="switch">
						<input type="checkbox" id="draw-polygon" class="header-checkbox regular-checkbox draw-polygon-class cmn-toggle cmn-toggle-round">
							<label for="draw-polygon" class="label-heading"></label>
						</div>
					<div class="heading-name">
						<p class="selectable-heading extra_option">Draw Polygon</p>
					</div>
					<div class="rotate-img">
						<span class="rotate glyphicon glyphicon-chevron-up" aria-hidden="true"></span>
					</div>
				...
				<div class="content-collapse col-md-12">
					<div class="pre_drawn_polygons col-md-12" style="margin-top:5px;">
							<?php 
			...
			<!-- Draw Polygon Container -->
			<!--Nbn Data Layers -->
			<?php if(isset($_SESSION['is_authorised_nbn_user']) && $_SESSION['is_authorised_nbn_user']==1 || $_SESSION['username'] == 'admin'){?>
			<div class="row nbn-data-layers">
				<div class="header-collapse bypass_check col-md-12 border-bottom-20">
					...
					<div class="heading-name">
						<p class="selectable-heading extra_option">NBN Zones</p>
					</div>
					<div class="rotate-img">
						<span class="rotate glyphicon glyphicon-chevron-up" aria-hidden="true"></span>
					</div>
				...
				<div class="content-collapse col-md-12" id="nbn-data-layers_box">
					<?php if(isset($_SESSION['nbn_user_type']) && $_SESSION['nbn_user_type']=='full_access' || $_SESSION['username'] == 'admin'){ ?>
					<div class="row">
						<div class="col-md-12">
							<div class="form-group my_polygons">
								<input  type="checkbox"  id="drawing_mode" value="1" data-docid="1" disabled> <label class="text-primary">Draw Polygon</label>
					...
					<?php }?>
					<div class="row">
							<div id="nbn_list_option" style="display:none; margin-left:15px !important;">
							<button id="show_nbn_layers" class="btn btn-primary" onclick="show_nbn_layers();">Zone List</button>
							<button id="hide_nbn_layers" class="btn btn-primary" onclick="hide_nbn_layers();" style="display:none;">Hide List </button>
							<?php 
								if($_SESSION['username'] == 'admin'){
									$nbn_user_type='full_access';
								}else{
									$nbn_user_type=$_SESSION['nbn_user_type'];
								}
							?>
							<input type="hidden" id="nbn_user_type" value="<?php echo $nbn_user_type;?>">
					</div>
					<div class="pre_drawn_nbn_polygons col-md-12" style="margin-top:5px; display:none;">
							<?php 
							$current_user_id = $_SESSION['user_id'];
							$glob = glob("user_kmls/$current_user_id/*.kml");
							if(!empty($glob))
...
<!-- Popup container after comletion of nbn polygon -->
        ...
        <div class="modal-content">
            ...
            <form  method="POST" id="save_nbn_alert_form" class="save_polygon_form">
                ...
                <div class="modal-footer">
                     ...
                     <input type="hidden" name="send_alert_type" value="" id="send_alert_type">
                        <button type="button" name="save_poly" value="save_poly" id="cancel_polygon" class="btn btn-primary" data-dismiss="modal">Cancel</button>
