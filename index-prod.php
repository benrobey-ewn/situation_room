...
<html>
    ...
    <body>
       ...
       <div class="navigation">
        ...
        <div id="radar_confirm_display" class="radar_confirm_display" style="display: none; left: 500px;">
             <div class="containertext" style="">Try changing the radar to &nbsp;&nbsp;<a class="hide_alerts" onclick="javascript:setMapRadarControl('256');">
                <b>256 km </b></a>&nbsp; or &nbsp;<a class="hide_alerts" onclick="javascript:setMapRadarControl('128');"><b>128 km </b></a> &nbsp;&nbsp;
                <a class="hide_alerts" onclick="javascript:hideConfirmbox();"><b>Cancel</b></a>
            </div>
        </div>
