...
<script type="text/javascript">
	...
	/* function for custum php encode comparison */
	...
	function show_map(id,polygon_type,color_code,url,created_date)
	{
		created_date=urldecode(created_date);
		created_date=decodeURI(created_date);
		opener.draw_map(polygon_type,color_code,url,id,'external',created_date);
		$('#show'+id).hide();
		$('#hide'+id).show();
               			...
               			<?php if(count($Alert_array)>0) {
               				foreach ($Alert_array as $element) {
               					if(in_array($element['topic_id'],$SevereWeather)) {
               						$class='pink';
               						$colorcode='#FFC0CB';
               					} else if ($element['topic_id']=='28' || $element['topic_id']=='35') {
               						$class='red';
               						$colorcode='#FF0000';
               						...
               						$class='blue';
               						$colorcode='#0000FF';
               					} else if (($element['topic_id']=='36' || $element['topic_id']=='1') &&  ((strpos($element['Subject'],'Bushfire Watch & Act') !== false) || (strpos($element['Subject'],'Bushfire Watch and Act') !== false) || (strpos($element['Subject'],'Bushfire Watch &amp; Act') !== false) || (strpos($element['Subject'],'Bushfire Watch And Act') !== false) || (strpos($element['Subject'],'Bushfire Emergency Warning') !== false) || (strpos($element['Subject'],'Bushfire Advice') !== false))) {
               						
               						if ((strpos($element['Subject'],'Bushfire Watch & Act') !== false) || (strpos($element['Subject'],'Bushfire Watch &amp; Act') !== false) || (strpos($element['Subject'],'Bushfire Watch and Act') !== false) || (strpos($element['Subject'],'Bushfire Watch And Act') !== false) || (strpos($element['Subject'],'Bushfire Emergency Warning') !== false) && ($detectByName=='Bushfire' || $detectByName=='Bushfire Watch')) {
               							$class='purple';
               							$colorcode='#800080';
               						} else if(strpos($element['Subject'],'Bushfire Advice') !== false && strpos($element['Subject'],'Bushfire') !== false){
               							$class='brown';
               							$colorcode='#A52A2A';
               						}
               					...
               					$element['CreatedDate']=$element['CreatedDate'].'Z';
                        //echo $class; die;
               					?> 
               					<li class="<?php echo $class;?>">
               						...
               						<div class="buttonmap">
               							<a id="<?php echo $show_id; ?>" href="javascript:void(0);" onclick='show_map(<?php echo $element['id']; ?>,<?php echo $corodinates; ?>,"<?php echo $colorcode; ?>","<?php echo $element['AlertFullURL'];?>","<?php echo $element['CreatedDate']; ?>")' title="Show on Map">
               								Show on Map
