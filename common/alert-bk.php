               			...
               			<?php if(count($Alert_array)>0) {
               				foreach ($Alert_array as $element) {
               					if(in_array($element['topic_id'],$SevereWeather)) {
               						...
               						$class='blue';
               						$colorcode='#0000FF';
               					} else if (($element['topic_id']=='36' || $element['topic_id']=='1') && ((strpos($element['Subject'],'Bushfire Watch & Act') !== false) || (strpos($element['Subject'],'Bushfire Watch and Act') !== false) || (strpos($element['Subject'],'Bushfire Watch And Act') !== false) || (strpos($element['Subject'],'Bushfire Emergency Warning') !== false) || (strpos($element['Subject'],'Bushfire Advice') !== false))) {
               						
               						if ((strpos($element['Subject'],'Bushfire Watch & Act') !== false) || (strpos($element['Subject'],'Bushfire Watch and Act') !== false) || (strpos($element['Subject'],'Bushfire Watch And Act') !== false) || (strpos($element['Subject'],'Bushfire Emergency Warning') !== false) && ($detectByName=='Bushfire' || $detectByName=='Bushfire Watch')) {
               							$class='purple';
               							$colorcode='#800080';
