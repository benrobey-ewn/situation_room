...
.TableContainer
  ...
  #loader {
			height: 100%;
			opacity: 0.6;
			background:url(../images/ajax-loader-16.gif) no-repeat scroll 50% 50% rgba(255, 255, 255, 0.8);
                        left: 0;
			position: absolute;
			top: 0;
			width: 100%;
   ...
   // console.log(opener.latlongarray);
    for(l=0 ; l<opener.latlongarray.length;l++)
    {
       // console.log(latlongarray[l].polygonPrimaryKey);
        var mydata = 'selected_layer_value_current='+opener.getSelectBoxValue()+'&polygonPrimaryKey='+opener.latlongarray[l].polygonPrimaryKey+'&polygon_number='+l+'&minLat='+opener.latlongarray[l].minLat+'&minLong='+opener.latlongarray[l].minLong+'&maxLat='+opener.latlongarray[l].maxLat+'&maxLong='+opener.latlongarray[l].maxLong;
        $.ajax
        ({
            type: "POST",
            url: position_url,
                ...
                if(response.data.length>0) 
                {
                    ...
                    for (i=0;i<response.data.length;i++)
                    {
                        ...
                        if(google.maps.geometry.poly.containsLocation(myLatlng, present_polygon) == true)
                        {
                            ...
                            if(index<0)
                            {
                              ...
                              //}
                                ...
                                $('#display_markers_point_div').append(myhtml1);
                                   var myhtml3 = '<div class="title">'+response.polygon_subject+'  ('+opener.latlongarray[l].created_date+')</div><div id="TableBody'+l+'" class="TableBody"></div>';
                            ...
                            newElements['created_date'] = opener.latlongarray[l].created_date;
    ...
    var current_image_name='';
             ...
             switch (layer_name) {
                ...
                case 'Ericsson Active Sites':
                    current_image_name="black_dot.png";
                    break;
                 ...
                 case 'Dexus Sites':
                    ...
                    break;
                 case 'Nab Sites':
                    current_image_name="nab_sites.png";
                    break;
                case 'Suncorp Sites':
                    current_image_name="suncorp_sites.png";
                    break;
                case 'Darling Basin Weir Sites':
                    current_image_name="dbw_sites.png";
                    break;
                case 'Boral Sites':
