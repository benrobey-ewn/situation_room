...
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
            <html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml"> 
              <head>
                <title>IDE00422.201508240010.tif</title>
          ...
          /*
                ...
                var mapBounds = new GLatLngBounds(new GLatLng(-44.2228902349, -49.4073406266), new GLatLng(44.2228902349, 49.4073406266));
                var mapMinZoom = 1;
                var mapMaxZoom = 6;
                   ...
                   if (GBrowserIsCompatible()) {
                      ...
                      tilelayer.getTileUrl = function(tile,zoom) {
                          ...
                          if (mapBounds.intersects(tileBounds)) {
                              return "http://54.153.195.116/storage/sat_data_output/test/" + zoom+"/"+tile.x+"/"+y+".png";
                          } else {
                              return "http://www.maptiler.org/img/none.png";
                          }
                      }
              ...
              <body onload="load()">
                  <div id="header"><h1>IDE00422.201508240010.tif</h1></div>
